...
public class TypeInstruction_Tests : InstructionHelper
{
	...
	[DataRow(typeof(DateTime), "[mscorlib]System.DateTime")]
	[DataRow(typeof(DBNull), "[mscorlib]System.DBNull")]
	[DataRow(typeof(decimal), "[mscorlib]System.Decimal")]
	...
	[DataRow(typeof(Dictionary<string, int>), "[mscorlib]System.Collections.Generic.Dictionary`2<string, int32>")]
	[DataRow(typeof(List<int>[]), "[mscorlib]System.Collections.Generic.List`1<int32>[]")]
	[DataRow(typeof(List<int>[,]), "[mscorlib]System.Collections.Generic.List`1<int32>[0...,0...]")]
	[DataRow(typeof(int[,]), "int32[0...,0...]")]
	[DataRow(typeof(LocalEnum), "[Transeric.Reflection.Tests]Transeric.Reflection.Tests.TypeInstruction_Tests/LocalEnum")]
	[DataRow(typeof(LocalClass), "[Transeric.Reflection.Tests]Transeric.Reflection.Tests.TypeInstruction_Tests/LocalClass")]
	[DataRow(typeof(LocalClass.InnerClass), "[Transeric.Reflection.Tests]Transeric.Reflection.Tests.TypeInstruction_Tests/LocalClass/InnerClass")]
	[DataRow(typeof(List<DateTime>), "[mscorlib]System.Collections.Generic.List`1<valuetype [mscorlib]System.DateTime>")]
	[DataRow(typeof(List<FileInfo>), "[mscorlib]System.Collections.Generic.List`1<class [mscorlib]System.IO.FileInfo>")]
