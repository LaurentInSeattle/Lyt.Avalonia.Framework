...
using Lyt.Avalonia.Interfaces.Messenger;
...
public sealed class Messenger : IMessenger
{
    ...
    public Messenger(ILogger logger, IDispatch dispatcher)
    {
        this.logger = logger;
        ...
        where TMessage : class
    {
        ...
        _ = weakActions.Add(new WeakAction<TMessage>(
            this.logger, this.dispatcher, target, action, withUiDispatch, doNotLog));
    }
